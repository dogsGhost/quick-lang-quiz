...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_Main2.default, { src: _db2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          'Translate',
	          this.state.quizStarted ? _react2.default.createElement(
	            'span',
	            null,
	            ' ',
	            this.state.count,
	...
	Main.propTypes = {
	  src: _react2.default.PropTypes.object.isRequired
	};
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.curIndex === dataLen) {
	        ...
	        var getNumCorrect = function getNumCorrect() {
	          return _this2.state.answers.filter(function (answer) {
	            return answer.isCorrect;
	          }).length;
	        };
	        var percentage = Math.round(getNumCorrect() / dataLen * PERCENT_MULTIPLE);
	        var answerNodes = this.state.answers.map(function (answer, index) {
	          return _react2.default.createElement(
	            'li',
	            {
	              key: index,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'quiz-text' },
	            _utils2.default.capitalize(data[this.state.curIndex].english),
	            '.'
	          ),
	          _react2.default.createElement('input', {
	            type: 'text',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _p = exports._p = {
	  getDeterminer: function getDeterminer(gender, src) {
	    ...
	    return _utils2.default.sample(src.determiner.filter(function (i) {
	      return gender === i.gender;
	    }));
	    // }
	    // return false;
	  },
	  ...
	  getWord: function getWord(key, src) {
	    return _utils2.default.sample(src[key]);
	  },
	  getPhrase: function getPhrase(src) {
	    var lang = arguments.length <= 1 || arguments[1] === undefined ? 'es' : arguments[1];

	    var pronounObj = _p.getWord('pronoun', src);
	    var verbObj = _p.getWord('verb', src);
	    var nounObj = _p.getWord('noun', src);
	    var detObj = _p.getDeterminer(nounObj.gender, src);
	    var phraseObj = {
	      english: pronounObj.en + ' ' + verbObj.en + ' ',
	      translation: pronounObj[lang] + ' ' + verbObj[lang][pronounObj.en] + ' '
	    };
	  ...
	  getPhrases: function getPhrases(_ref) {
	    var _ref$lang = _ref.lang;
	    var lang = _ref$lang === undefined ? 'es' : _ref$lang;
	    var _ref$count = _ref.count;
	    var count = _ref$count === undefined ? DEFAULT_COUNT : _ref$count;
	    var src = _ref.src;
